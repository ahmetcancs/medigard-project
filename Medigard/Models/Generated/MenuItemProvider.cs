...
{
    /// <summary>
    /// Provides methods for retrieving pages of type MenuItem.
    /// </summary>
    public partial class MenuItemProvider
    {
        /// <summary>
        /// Returns a query that selects published pages of type MenuItem.
        /// </summary>
        public static DocumentQuery<MenuItem> GetMenuItems()
        {
        ...
        /// <param name="siteName">The name of the site where the page belongs.</param>
        /// <param name="cultureName">The name of the language, e.g. en-US, that determines which localized version should be retrieved.</param>
        public static DocumentQuery<MenuItem> GetMenuItem(Guid nodeGuid, string cultureName, string siteName)
        {
        ...
        /// <param name="siteName">The name of the site where the page belongs.</param>
        /// <param name="cultureName">The name of the language, e.g. en-US, that determines which localized version should be retrieved.</param>
        public static DocumentQuery<MenuItem> GetMenuItem(string nodeAliasPath, string cultureName, string siteName)
        {
